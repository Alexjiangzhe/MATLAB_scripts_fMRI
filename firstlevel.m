...
% 路径
onset_base_dir   = 'D:\TIAOJIANJIQIXUEXI\ONSET';    % 每个被试一个文件夹，里面是5个xlsx
preproc_base_dir = 'D:\tiaojianjiqixuexi\pre';      % 例如 D:\tiaojianjiqixuexi\pre\16\swuaf\*.nii
output_base_dir  = 'D:\tiaojianjiqixuexi\first'; % 结果输出路径（你可以改成自己想要的）
